...
<figure>
  <div style="text-align:center">
    <img src="/assets/img/t_mass/tab1.png" alt="Table 1 - Text-to-Video Retrieval Results" style="width:80%;">
  </div>
</figure>

- Table 1: LSMDC에서 ViT-B/32 모델 기준 CLIP-ViP 대비 R@1 성능 3.3% 향상

<figure>
  <div style="text-align:center">
    <img src="/assets/img/t_mass/tab2.png" alt="Table 2" style="width:80%;">
  </div>
</figure>

- Table 2: DiDeMo에서 X-Pool 대비 R@1 성능 6.0% 향상** (ViT-B/16 기준)
- 일관된 성능 향상
...
<figure>
  <div style="text-align:center">
    <img src="/assets/img/t_mass/tab3.png" alt="Table 3" style="width:60%;">
  </div>
</figure>

- Table 3: 비디오-텍스트 검색(video-to-text retrieval)에서도 T-MASS가 최고 성능을 기록
...
<figure>
  <div style="text-align:center">
    <img src="/assets/img/t_mass/tab5.png" alt="Table 5" style="width:80%;">
  </div>
</figure>

- Table 5에서 유사도 기반 반경 모듈을 세 가지 방식으로 구현:
...
<figure>
  <div style="text-align:center">
    <img src="/assets/img/t_mass/tab6.png" alt="Table 6" style="width:80%;">
  </div>
</figure>
...
<figure>
  <div style="text-align:center">
    <img src="/assets/img/t_mass/fig5.png" alt="Fig 5 - Retrieval Analysis" style="width:80%;">
  </div>
</figure>
...
- Figure 6: Support Text Regularization $\alpha$ 에 따른 성능 분석
  - 최적 $\alpha$ 값: 1.2
...
- 본 연구는 **텍스트 표현의 확장 가능성을 강조하며, 향후 연구에 기여할 수 있는 새로운 패러다임을 제안**
