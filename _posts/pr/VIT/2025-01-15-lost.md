...
**Datasets**  
본 연구는 세 가지 객체 지역화 변형 문제를 다루며, 이를 평가하기 위해 다음 데이터셋을 사용합니다:
1. **VOC07** [22] trainval+test
2. **VOC12** [21] trainval
3. **COCO 20k** [40, 68]  
   COCO 20k는 COCO2014 trainval 데이터셋 [40]의 19,817개 랜덤 이미지를 포함하며 [68]에서 벤치마크로 사용되었습니다.
