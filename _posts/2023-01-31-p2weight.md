...
title: "[Paper review] Perception Prioritized Training of Diffusion Models (P2 weighting)"
...
tags:
  ...
  - Computer Vision
  - AI
excerpt: "P2 weighting Paper review"
use_math: true
classes: wide
---
...
모든 실험에서 $T = 1000$으로 설정하였으며 잘 디자인된 아키텍처와 효율적인 샘플링을 제공하는 ADM ([Paper review](https://kimjy99.github.io/Paper review/dmbg/)) 모델을 사용하였다. 
