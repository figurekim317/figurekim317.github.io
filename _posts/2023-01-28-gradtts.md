...
through SDEs 논문 ([Paper review](https://kimjy99.github.io/Paper review/sbgm/))에서는 이 Markov chain이 특정 SDE를 만족하는 stochastic process의 궤적을 근사한다고 설명한다. 
