...
<figure>
  <div style="text-align:center">
    <img src="\fpost\images\pf1\segmentation 0.png" alt="대체 텍스트" style="width:50%;">
  </div>
  <figcaption style="text-align:center">이미지 설명</figcaption>
</figure>
...
| EfficientPS  | 4.3 MB     | 23.5                  | 72.3 mIoU / 0.83 RMSE         |
| FastDepthSeg | 1.9 MB     | 140.8                 | 70.1 mIoU / 0.83 RMSE         |
| DDRNet       | 7.5 MB     | 82.7                  | 78.2 mIoU / 0.82 RMSE         |
| DeepLab V3+  | 8.4 MB     | 37.6                  | 77.7 mIoU                     |

<figure>
  <div style="text-align:center">
    <img src="\fpost\images\pf1\segmentation 1.png" alt="대체 텍스트" style="width:50%;">
  </div>
  <figcaption style="text-align:center">이미지 설명</figcaption>
</figure>
...
<figure>
  <div style="text-align:center">
    <img src="\fpost\images\pf1\segmentation 2.png" alt="대체 텍스트" style="width:50%;">
  </div>
  <figcaption style="text-align:center">이미지 설명</figcaption>
</figure>
