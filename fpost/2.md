...
<figure>
  <div style="text-align:center">
    <div style="display:inline-block; margin-right:10px;">
      <img src="/fpost/images/pf2/layerwise activation.png" alt="대체 텍스트" style="width:40%;">
    </div>
    <div style="display:inline-block;">
      <img src="/fpost/images/pf2/channel-wise normalization.PNG" alt="대체 텍스트" style="width:40%;">
    </div>
  </div>
